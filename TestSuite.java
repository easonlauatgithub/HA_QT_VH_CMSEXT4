...
java -Dwebdriver.ie.driver="IEDriver32Server.exe" -jar selenium-server-standalone-3.14.0.jar -role node -port 5555 -hub http://160.66.133.194:4444/grid/register
NODE 2
cd C:\eclipse_neon
