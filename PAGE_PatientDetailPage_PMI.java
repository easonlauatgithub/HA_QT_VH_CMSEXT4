...
class PAGE_PatientDetailPage_PMI {
	...
	public void switchToIframe(){
		...
		shared_functions.switchToFrameByString("96Panel");			
	}
	public void clickTab(int idxTabName) {
		//idxTabName: 0 PMI Enq, 1 NOK
		switchToIframe();
		List<WebElement> liTab = shared_functions.getElementsWhenVisible(By.cssSelector("body>div.x-panel>div.x-tab-bar a"));
		liTab.get( idxTabName ).click(); 
	}
	public void clickCollapsibleTabToExpand(int idxCollapsibleTab) {
		// idxCollapsibleTab: 0 demographic, 1 address
		switchToIframe();
		List<WebElement> liExpandable = shared_functions.getElementsWhenVisible(By.cssSelector("img.x-tool-img.x-tool-expand-bottom"));
		liExpandable.get( idxCollapsibleTab ).click();
	}
	public void clickCollapsibleTabToCollapse(int idxCollapsibleTab) {
		// idxCollapsibleTab: 0 demographic, 1 address
		switchToIframe();
		List<WebElement> liCollapsible = shared_functions.getElementsWhenPresent(By.cssSelector("img.x-tool-img.x-tool-collapse-top"));
		liCollapsible.get( idxCollapsibleTab ).click();
	}
	/*
	public void clickCollapsibleTab_TBD(String cExpandOrCollapse, int idxCollapsibleTab) {
		// cExpandOrCollapse: c Collapse, e Expand
		// idxCollapsibleTab: 0 demographic, 1 address
		switchToIframe();
		List<WebElement> liExpandable = shared_functions.getElementsWhenVisible(By.cssSelector("img.x-tool-img.x-tool-expand-bottom"));
		List<WebElement> liCollapsible = shared_functions.getElementsWhenVisible(By.cssSelector("img.x-tool-img.x-tool-collapse-top"));
	...
	*/
	...
	public void expandPatientDemographic() {clickCollapsibleTabToExpand(0);}
	public void collapsePatientDemographic() {clickCollapsibleTabToCollapse(0);}
	public void expandPatientAddress() {clickCollapsibleTabToExpand(1);}
	public void collapsePatientAddress() {clickCollapsibleTabToCollapse(1);}
	public String getPatientAddress(){
		switchToIframe();
		List<WebElement> liPatientAddressItem = shared_functions.getElementsWhenVisible(By.cssSelector("div[id^=patientAddressPanel] table.x-field"));
	...
	public Map getMapOfPatientDemographicData() {
		switchToIframe();
		List<WebElement> liPatientDemographicItem = shared_functions.getElementsWhenVisible(By.cssSelector("div[id^=patientDemoPanel] table.x-field"));
	...
	public ArrayList<ArrayList<String>> getTableEpisodeCaseList(){
		...
		List<WebElement> liRows = shared_functions.getElementsWhenVisible(By.cssSelector(str_li1));
